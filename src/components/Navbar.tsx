...
const Navbar: React.FC = () => {
  ...
  const navItems: NavItem[] = [
    ...
    { name: "Skills",
      href: "/#skills",
      subItems:[
        { name: "Skills and Technologies", href: "/skillsandtech" },
      ]
    },
    { name: "Projects",
      href: "/#projects",
  ...
  return (
      ...
      <header className="fixed w-full top-5 z-50">
        ...
        <div
          className={`max-w-6xl mx-auto flex items-center justify-between text-base px-4 py-2 rounded-2xl shadow-lg backdrop-blur-lg border border-gray-600 ${ darkMode ? "bg-black/50 text-white" : "bg-white/50 text-black"} transition-colors duration-300`}>
          {/* Logo */}
            ...
            {navItems.map((item) => (
              item.subItems ? (
                <div key={item.name} className="relative group">
                  ...
                  <ul className={`absolute left-0 mt-4 w-72 rounded-md shadow-lg p-4 invisible opacity-0 backdrop-blur-xl group-hover:visible group-hover:opacity-100 transition-all  duration-300 ${darkMode ? "bg-black/90" : "bg-white/90"}`}>
          ...
          >
                ...
                {item.subItems ? (
                  <>
                    <button
                      ...
                      className={`flex items-center justify-between w-full px-6 py-2 font-semibold rounded transition-colors duration-200 ${
                        ...
                        {item.subItems.map((subItem) => (
                          <li key={subItem.name}>
                            <Link
                              ...
                              className={`block w-full text-left px-6 py-2 rounded transition-colors duration-200 ${
                                darkMode ? "hover:bg-white/10" : "hover:bg-gray-300"
                              }`}
                            >
                              {subItem.name}
                            </Link>
                  ...
                  <Link
                    ...
                    className={`block w-full text-left px-6 py-2 rounded font-semibold hover:bg-gray-100 dark:hover:bg-gray-700 ${
            ...
            <div
              className={`flex flex-col gap-2 text-xl items-center space-x-3 rounded-lg backdrop-blur-lg px-4 py-2 ${
                darkMode ? "bg-black/50 text-white" : ""
        ...
        <div className={`absolute right-6 top-0 w-40 flex items-center justify-center text-base font-bold px-4 py-3 rounded-2xl shadow-lg backdrop-blur-lg border border-gray-600 ${ darkMode ? "bg-black/50 text-white" : "bg-white/50 text-black"} transition-colors duration-300`}>
          <Clock/>
        </div>
      </header>
